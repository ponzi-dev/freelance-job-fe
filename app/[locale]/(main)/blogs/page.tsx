        ...
        <>
            ...
            <section className="py-110 bg-offWhite">
                <div className="container">
                    <div className="row row-gap-4 row-cols-xl-4 row-cols-lg-3 row-cols-md-2">
                        <article>
                            <div className="blog-card">
                                <div className="position-relative">
                                    <a href="blog-details.html" className="d-block">
                                        <img
                                            src="assets/img/blog/bl-th-1.png"
                                            className="img-fluid blog-thumb w-100"
                                            alt=""
                                        />
                                    </a>
                                    <span className="blog-date position-absolute">08/01/2024</span>
                                </div>
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">
                                            Focused on their studies cropped shot of
                                        </a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                                        className="blog-link d-flex gap-3 align-items-center text-dark-200"
                                    >
                                        Learn More
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                <div className="position-relative">
                                    <a href="blog-details.html" className="d-block">
                                        <img
                                            src="assets/img/blog/bl-th-2.png"
                                            className="img-fluid blog-thumb w-100"
                                            alt=""
                                        />
                                    </a>
                                ...
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">
                                            Startup &amp; team as concept cropped shot
                                        </a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                ...
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">
                                            Tell me more about this as cropped shot.
                                        </a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                <div className="position-relative">
                                    <a href="blog-details.html" className="d-block">
                                        <img
                                            src="assets/img/blog/bl-th-4.png"
                                            className="img-fluid blog-thumb w-100"
                                            alt=""
                                        />
                                    </a>
                                ...
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">Graphics designer editor workplace</a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                                        className="blog-link d-flex gap-3 align-items-center text-dark-200"
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                <div className="position-relative">
                                    <a href="blog-details.html" className="d-block">
                                        <img
                                            src="assets/img/blog/bl-th-5.png"
                                            className="img-fluid blog-thumb w-100"
                                            alt=""
                                        />
                                    </a>
                                ...
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">
                                            Serious confident our curly bearded office.
                                        </a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                <div className="position-relative">
                                    <a href="blog-details.html" className="d-block">
                                        <img
                                            src="assets/img/blog/bl-th-6.png"
                                            className="img-fluid blog-thumb w-100"
                                            alt=""
                                        />
                                    </a>
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                <div className="position-relative">
                                    <a href="blog-details.html" className="d-block">
                                        <img
                                            src="assets/img/blog/bl-th-7.png"
                                            className="img-fluid blog-thumb w-100"
                                            alt=""
                                        />
                                    </a>
                                ...
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">
                                            Colleagues discussing in coworking office
                                        </a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                <div className="position-relative">
                                    <a href="blog-details.html" className="d-block">
                                        <img
                                            src="assets/img/blog/bl-th-8.png"
                                            className="img-fluid blog-thumb w-100"
                                            alt=""
                                        />
                                    </a>
                                ...
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">Cropped portrait of a hand some</a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                                        className="blog-link d-flex gap-3 align-items-center text-dark-200"
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                <div className="position-relative">
                                    <a href="blog-details.html" className="d-block">
                                        <img
                                            src="assets/img/blog/bl-th-9.png"
                                            className="img-fluid blog-thumb w-100"
                                            alt=""
                                        />
                                    </a>
                                ...
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">
                                            Coworkers talking about a project at the office
                                        </a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                <div className="position-relative">
                                    <a href="blog-details.html" className="d-block">
                                        <img
                                            src="assets/img/blog/bl-th-10.png"
                                            className="img-fluid blog-thumb w-100"
                                            alt=""
                                        />
                                    </a>
                                ...
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">
                                            Young attractive caucasian satisfied businessman
                                        </a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                ...
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">
                                            Multiethnic young working together in the office
                                        </a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                        ...
                        <article className="col-xl-3 col-lg-4 col-md-6">
                            <div className="blog-card">
                                <div className="position-relative">
                                    <a href="blog-details.html" className="d-block">
                                        <img
                                            src="assets/img/blog/bl-th-12.png"
                                            className="img-fluid blog-thumb w-100"
                                            alt=""
                                        />
                                    </a>
                                ...
                                <div className="blog-meta">
                                    ...
                                    <h3 className="blog-title fw-bold mb-3">
                                        <a href="blog-details.html">Group of business people working</a>
                                    </h3>
                                    <a
                                        href="blog-details.html"
                                        className="blog-link d-flex gap-3 align-items-center text-dark-200"
                            ...
                            <nav aria-label="Page navigation example">
                                <ul className="custom-pagination pagination">
                                    <li className="custom-page-item page-item">
                                        <a className="custom-page-link page-link" href="blogs.html#">
                                            Previous
                                        </a>
                                    </li>
                                    <li className="custom-page-item page-item">

                    ...
                    <div className="">
                        <div className="row pb-4">
                            <div className="col-lg-8 mb-30 mb-lg-0">
                                <div className="job-posts-container bg-white">
                                    <div className="row justify-content-between pb-5">
                                        <div className="col-auto mb-40 mb-md-0">
                                            <div>
                                                <p className="job-type d-flex gap-2 align-items-center mb-1">
                                                    <svg
                                                    ...
                                                    Job type: <span>Hourly</span>
                                                </p>
                                                <h3 className="job-post-title fw-bold mb-1">
                                                    Sr. Marketing Director
                                                </h3>
                                                <p className="job-company mb-2">QuomodoSoft</p>
                                        ...
                                        <div className="col-auto">
                                            ...
                                            <h3 className="job-wage fw-bold mt-4">$1,000-1500/m</h3>
                                        </div>
                                    </div>
                                    <div className="pt-5 border-top">
                                        <div className="content-details">
                                            <div className="mb-30">
                                                <h4 className="fw-semibold text-18 text-dark-300 mb-2">
                                                    Job Description
                                                </h4>
                                                <p className="text-dark-200 lh-2">
                                                    Sed ut perspiciatis unde omnis iste natus error sit
                                                    voluptatem accusantium doloremque laudantium, totam rem
                                                    aperiam, eaque ipsa quae ab illo inventore veritatis et
                                                    quasi as architecto beatae vitae dicta sunt explicabo. Nemo
                                                    enim ipsam voluptatem quia voluptas sit aspernatur aut odit
                                                    aut fugit, Sed quia consequuntur magni dolores as eos qui
                                                    ratione voluptatem our sequi nesciunt. Neque porro quisquam
                                                    est, qui dolorem ipsum quia dolor sit amet, consectetur,
                                                    adipisci velit, sed quia non numquam eius modi tempora
                                                    incidunt ut laboxre et dolore magnam aliquam quaerat
                                            ...
                                            <div className="mb-30">
                                                ...
                                                <ul>
                                                    <li className="text-dark-200">
                                                        ...
                                                        Directors of experience design to concept andoversee the
                                                        production of bold, innovative, award-winning campaigns
                                                        and digital experiences.
                                                    </li>
                                                    <li className="text-dark-200">
                                                        Make strategic and tactical UX decisions related to design
                                                        and usability as well as features andfunctions.
                                                    </li>
                                                    <li className="text-dark-200">
                                                    ...
                                                    <li className="text-dark-200">
                                                        ...
                                                        stakeholders. You’ll be the greatest advocate forour work,
                                                        but you’ll also listen and internalize feedback that we
                                                        can come back with creative thatexceeds expectations.
                                                    </li>
                                                </ul>
                                            </div>
                                            <div className="mb-30">
                                                ...
                                                <ul>
                                                    ...
                                                    <li className="text-dark-200">
                                                        ...
                                                        typographic skills, as well as creativity andability to
                                                        adhere to brand standards.
                                                    </li>
                                                    <li className="text-dark-200">
                                                        Expertise in Figma, Adobe Creative Cloud suite, Microsoft
                                                        suite.
                                                    </li>
                                                    <li className="text-dark-200">
                                                        Forever learning: Relentless desire to learn and leverage
                                            ...
                                            <div className="mb-30">
                                                <p className="text-dark-200">
                                                    ...
                                                    corrupti quos dolores et quas molestias excepturi sint as
                                                    occaecati cupiditate non provident, similique sunt in culpa
                                                    qui officia deserunt mollitia animi, id est laborum et
                                                    dolorum fuga. Et harum quidem rerum facilis est et expedita
                                                    distinctio. Nam our libero tempore, cum soluta nobis est
                                                    eligendi optio cumque nihil impedit quo minus id quod maxime
                                                    placeat facere possimus, omnis voluptas assumenda est, omnis
                                                    dolor here as repellendus. Temporibus autem quibusdam et aut
                            ...
                            <div className="col-lg-4">
                                <div className="bg-white company-profile-card">
                                    <div className="d-flex gap-3 align-items-center company-profile-card-header">
                                        <div className="company-profile-card-icon">
                                            <img src="assets/img/job/1-sm.png" alt="" />
                                        </div>
                                        <div>
                                            <h4 className="company-profile-card-title fw-bold">
                                                QuomodoSoft
                                            </h4>
                                            <p className="company-profile-card-desc">Dhaka, Bangladesh</p>
                                        </div>
                                    </div>
                                    <ul className="company-card-list">
                                        <li className="py-3 d-flex justify-content-between gap-3 text-dark-200 company-card-list align-items-center">
                                            ...
                                            <span className="text-dark-200 fs-6">Software</span>
                                        </li>
                                        <li className="py-3 d-flex justify-content-between gap-3 text-dark-200 company-card-list align-items-center">
                                        ...
                                        <li className="py-3 d-flex justify-content-between gap-3 text-dark-200 company-card-list align-items-center">
                                            <div className="d-flex gap-3 text-dark-200 align-items-center">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width={21}
                                                    height={21}
                                            ...
                                            <div>
                                                <span className="text-dark-200 fs-6">25</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>

                ...
                <div className="dashboard-header-btns d-flex gap-3">
                    ...
                    <div className="d-none d-md-block">
                        <button className="dashboard-header-btn">
                            ...
                            >
                                <path
                                    d="M1 10V5C1 2.79086 2.79086 1 5 1H17C19.2091 1 21 2.79086 21 5V15C21 17.2091 19.2091 19 17 19H7M5 6L8.7812 8.5208C10.1248 9.41653 11.8752 9.41653 13.2188 8.5208L17 6M1 13H7M1 16H7"
                                    stroke="#06131C"
                                    strokeWidth="1.5"
                                    strokeLinecap="round"
                                />
                    ...
                    <div className="dropdown d-none d-md-block">
                        <button
                            ...
                            aria-expanded="false"
                            className="dashboard-header-btn dropdown-toggle"
                        >
                            <svg
                                width={24}
                                height={24}
                            ...
                            <span className="header-btn-badge">8</span>
                        </button>
                        <div className="dropdown-menu">
                            ...
                            <div className="text-center mx-2 mt-2">
                                <button className="see-notification-btn">See All</button>
                            </div>
                        </div>
                    </div>
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            fillRule="evenodd"
                                            clipRule="evenodd"
                                            d="M0.0294457 3.51219L8.23549 9.48022C9.28744 10.2453 10.7126 10.2453 11.7645 9.48022L19.9706 3.51219C19.7299 1.53314 18.044 0 16 0H4C1.95599 0 0.270068 1.53314 0.0294457 3.51219ZM20 5.96377L12.9409 11.0977C11.1876 12.3728 8.81239 12.3728 7.05914 11.0977L0 5.96377V14C0 16.2091 1.79086 18 4 18H16C18.2091 18 20 16.2091 20 14V5.96377Z"
                                            fill="#22BE0D"
                                        />
                                    </svg>
                                    Inbox
